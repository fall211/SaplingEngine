...
auto Physics2D::bBoxCollision(const std::shared_ptr<Entity>& e0, const std::shared_ptr<Entity>& e1) -> glm::vec2 {
    ...
    **/
    ...
    const glm::vec2 dr = e0->getComponent<CTransform>().position - e1->getComponent<CTransform>().position;
...
auto bCircleCollision(const std::shared_ptr<Entity>& e0, const std::shared_ptr<Entity>& e1) -> glm::vec2 {
    ...
    **/
    ...
    const glm::vec2 pos0 = e0->getComponent<CTransform>().position;
    const glm::vec2 pos1 = e1->getComponent<CTransform>().position;
...
auto bBoxCircleCollision(const std::shared_ptr<Entity>& eBox, const std::shared_ptr<Entity>& eCircle) -> glm::vec2 {
    ...
    **/
    ...
    const glm::vec2 circlePos = eCircle->getComponent<CTransform>().position;
    const float circleR = eCircle->getComponent<CBCircle>().radius;

    const glm::vec2 boxPos = eBox->getComponent<CTransform>().position;
